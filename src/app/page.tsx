...
export default function Page() {
    ...
    const terms: { group: string; items: Term[] }[] = [
        ...
        },
        {
            group: "2027",
            items: [
                {label: "2027S", ay: "2027", season: "Spring", value: "2027Spring"},
                {label: "2027A", ay: "2027", season: "Autumn", value: "2027Autumn"},
                {label: "2027W", ay: "2027", season: "Winter", value: "2027Winter"},
            ],
        },
    ];
