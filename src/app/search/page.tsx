...
import { IconShoppingCart, IconX, IconTrash, IconExternalLink} from '@tabler/icons-react';
import { selectedCoursesAtom } from "../../stories/atoms";
import { Course, Schedule } from '../../type/2025/Types';
    ...
    <Container fluid p="md" style={{ minHeight: '100vh', backgroundColor: isDarkMode ? '#1A1B1E' : '#F8F9FA' }}>
      <Box mb="md">
        <Group justify="space-between">
          ...
          <Button component={Link} href="/2025" variant="filled" color="teal">
            {language === 'J' ? '戻る' : 'Back'}
          </Button>
        </Group>
      </Box>
